...
//    return ((LinkedJobInfoList)((PSJobInfoList)Queue).getInternalList()).getInternalList().getFirst().getJob();       
    return ((LinkedJobInfoList)Queue).getInternalList().getFirst().getJob();   
  }
